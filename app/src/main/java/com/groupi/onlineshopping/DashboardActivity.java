...
import com.groupi.onlineshopping.admin.AdminMaintainEditProductsActivity;
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(type.equals("Admins"))
                        {
                            ...
                            Intent intent = new Intent(DashboardActivity.this, AdminMaintainEditProductsActivity.class);
